wp-json/oembed/1.0/embed?url=http%3A%2F%2Fxn--90abjzldcl.xn--p1ai%2F&format=xml', 'http://xn--90abjzldcl.xn--p1ai/wp-content/plugins/waiting/css/style.css?v=0.4.7', 'http://xn--90abjzldcl.xn--p1ai/wp-includes/wlwmanifest.xml', 'http://xn--90abjzldcl.xn--p1ai/wp-content/themes/bwstheme/slick/slick.css', 'http://xn--90abjzldcl.xn--p1ai/xmlrpc.php'}
outbound = {'https://s.w.org/images/core/emoji/11/svg/', 'http://gmpg.org/xfn/11', 'https://s.w.org/images/core/emoji/11/72x72/', 'https://app.partnerlottery.com/aff.php?id=574_1_3_6', 'http://xn--90abjzldcl.xn--p1ai', '//s.w.org', 'https://fonts.googleapis.com/css?family=Open+Sans', 'https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/css/bootstrap.min.css', 'https://use.fontawesome.com/releases/v5.6.3/css/all.css'}

js_outbound = {'http://', 'http://www.youtube.com/embed/', 'https://ssl.', 'https://www.gstatic.com/cv/js/sender/v1/cast_sender.js', 'http://p.jwpcdn.com/'}
...
XML_INBOUND = [{'http://xn--90abjzldcl.xn--p1ai/loterejnye-pobedy-kakova-prichina-slepoj-very-uchastnikov-v-chudo',
  ...
  'http://xn--90abjzldcl.xn--p1ai/loterejnye-pobedy-kakova-prichina-slepoj-very-uchastnikov-v-chudo/feed'}, set()]
...
def test_html_file_parsing():
    ...
    assert test_outbound == outbound
    assert test_inbound == inbound
...
# @pytest.mark.foo
@pytest.mark.parametrize('url, file_type', [
    ('http://xn--90abjzldcl.xn--p1ai/', 'text/html'),
    ...
    ('http://xn--90abjzldcl.xn--p1ai/wp-includes/wlwmanifest.xml', 'text/xml'),
    ('http://xn--90abjzldcl.xn--p1ai/feed', 'text/xml'),
    ('http://xn--90abjzldcl.xn--p1ai/wp-json/', 'application/json'),
    ('http://xn--90abjzldcl.xn--p1ai/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fxn--90abjzldcl.xn--p1ai%2F',
     'application/json')
])
def test_file_write(url, file_type):
    async def request_for_file_saving(url_to_request, type_s):
        async with aiohttp.ClientSession() as session:
            async with session.get(url_to_request) as response:
                return await HtmlHandler.write_binary(response, type_s)

    path = asyncio.run(request_for_file_saving(url, file_type))
...
def test_xml_parser(url, number):
    ...
    assert xml_class.outbound == XML_OUTBOUND[number]@pytest.mark.foo
...
@pytest.mark.parametrize('url, file_type, path', [
    ...
    ('http://127.0.0.1:5000/directory/some_page.php?id=10', 'text/html', ['/directory', 'some_page_php?id=10.html']),
    ('http://127.0.0.1:5000/directory/some_page?id=10', 'text/html', ['/directory', 'some_page?id=10.html']),
    ('http://127.0.0.1:5000/directory/some_page?id=10&user=borya&count=50', 'text/html',
     ['/directory', 'some_page?id=10&user=borya&count=50.html']),
    ('http://127.0.0.1:5000/directory/some_page.php?id=10&user=borya&count=50', 'text/html',
     ['/directory', 'some_page_php?id=10&user=borya&count=50.html']),
])
